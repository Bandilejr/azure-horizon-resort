...
export function Restaurant({ onBack }: RestaurantProps) {
  const { user } = useAuth();
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-serif font-bold text-[#1e3a5f]">Dining Room</h2>
            <p className="text-sm text-gray-500">Premium Resort Cuisine</p>
          </div>
        </div>
        <Button 
          variant="outline" 
          className="relative border-[#1e3a5f] text-[#1e3a5f]"
      ...
      <div className="flex gap-4 p-4 bg-gray-50 rounded-lg">
        <Button
          ...
          className={orderType === 'dine_in' ? 'bg-[#1e3a5f]' : ''}
        ...
        <Button
          ...
          className={orderType === 'takeaway' ? 'bg-[#1e3a5f]' : ''}
        ...
        {isResident && (
          <Button
            ...
            className={orderType === 'room_delivery' ? 'bg-[#1e3a5f]' : ''}
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-green-800">Table Reserved</p>
      ...
      {Object.entries(menu).map(([category, items]) => (
        <div key={category} className="space-y-4">
          <h3 className="text-lg font-bold capitalize text-[#1e3a5f] border-b pb-2">{category}</h3>
          <div className="grid md:grid-cols-2 gap-4">
            {items.map((item) => (
              <Card key={item.id} className="border-none shadow-sm ring-1 ring-gray-100 overflow-hidden">
                {item.image && (
                ...
                <CardContent className="p-4 flex justify-between items-center">
                  <div className="space-y-1 flex-1">
                    ...
                    <p className="font-bold text-[#c9a227]">R {item.price}</p>
                  </div>
